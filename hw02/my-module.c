...
{
    printk(KERN_INFO "LOADING my-module, which was written by nicolas bertagnolli.\n");
    return 0;	// Non-zero return means that the module couldn't be loaded.
}

static void __exit hello_cleanup(void)
{
    printk(KERN_INFO "UNLOADING my-module, which was written by nicolas bertagnolli.\n");
}
